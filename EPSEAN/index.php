...
<html lang="en">
  <head>
    ...
    <link id="bodybg" href="bodybg/bg1.css" rel="stylesheet" type="text/css" />    <link id="t-colors" href="color/default.css" rel="stylesheet">
  </head>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="wow fadeInDown" data-wow-offset="0" data-wow-delay="0.1s">
                 <h2 class="h-ultra">ACCESO AL PORTAL</h2>
                </div>
                <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.1s">
                  <h4 class="h-light">INGRESA AQUÍ TUS DATOS DE ACCESO</h4>
                </div>
                    ...
                    <form class="Formulario" action="acceso.php" method="POST">
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                          ...
                          <select name="tipoid" class="form-control input-md">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" name="id" id="id" class="form-control input-md" data-rule="minlen:3">
                          <div class="validation"></div>
                        </div>
                      </div>
                      <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                          <label>Correo</label>
                          <input type="text" name="correo" id="email" class="form-control input-md" data-rule="minlen:3">
                          <div class="validation"></div><br>
                        </div>
                      </div>
                      <p class="text-right wow bounceIn" data-wow-delay="0.4s">
                        <input type="submit" value="Ingresar" class="btn btn-skin btn-lg"><br><br>
                        ¿No estás registrado? <a href="registro.php">Registrate aquí</a>
                      </p>
                    </form>
                  </div>
                </div>
